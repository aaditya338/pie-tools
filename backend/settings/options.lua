...
options.SETTINGS_GROUPS = {
    {
        key = "general",
        label = "General",
        description = "Global PieTools preferences.",
        options = {
            {
                key = "useSteamLanguage",
                label = "Use Steam Language",
                option_type = "toggle",
                description = "Use the Steam client's language for PieTools.",
                default = true,
            ...
            },
            {
                ...
                label = "Language",
                option_type = "select",
                description = "Choose the language used by PieTools.",
                default = "en",
            ...
            },
            {
                ...
                label = "Donate Keys",
                option_type = "toggle",
                description = "Allow PieTools to donate spare Steam keys. (placeholder option)",
                default = true,
                metadata = {yesLabel = "Yes", noLabel = "No"}
            },
            {
                ...
                label = "Theme",
                option_type = "select",
                description = "Choose the color theme for PieTools interface.",
                default = "original",
